...
it('check event listener is attached to the event', function () {
  ...
  // Assert
  Event::fake();
  event(new \SudoSuu\FilamentBlog\Events\BlogPublished($post));

  Event::assertDispatched(\SudoSuu\FilamentBlog\Events\BlogPublished::class);

  Event::assertListening(
    \SudoSuu\FilamentBlog\Events\BlogPublished::class,
