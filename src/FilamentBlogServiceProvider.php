...
use SudoSuu\FilamentBlog\Components\Card;
use SudoSuu\FilamentBlog\Components\Comment;
use SudoSuu\FilamentBlog\Components\FeatureCard;
use SudoSuu\FilamentBlog\Components\Header;
use SudoSuu\FilamentBlog\Components\HeaderCategory;
use SudoSuu\FilamentBlog\Components\Layout;
use SudoSuu\FilamentBlog\Components\RecentPost;
use SudoSuu\FilamentBlog\Console\Commands\RenameTablesCommand;
...
class FilamentBlogServiceProvider extends PackageServiceProvider
{
  ...
  public function register()
  {
    Route::bind('post', function ($value) {
      return \SudoSuu\FilamentBlog\Models\Post::where('slug', $value)->published()->firstOrFail();
    });
