...
class ShareSnippetResource extends Resource
{
  ...
  {
    return [
      'index' => \SudoSuu\FilamentBlog\Resources\ShareSnippetResource\Pages\ListShareSnippets::route('/'),
      'edit' => \SudoSuu\FilamentBlog\Resources\ShareSnippetResource\Pages\EditShareSnippet::route('/{record}/edit'),
    ];
  }
}
